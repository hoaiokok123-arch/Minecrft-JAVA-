...
static NSString *const kLauncherIntroHTML =
    ...
    ".brandplate{display:inline-flex;align-items:center;gap:12px;padding:10px 14px;border-radius:24px;background:linear-gradient(180deg,rgba(248,252,255,.26),rgba(214,236,252,.14));box-shadow:0 12px 24px var(--shadow);backdrop-filter:blur(22px) saturate(110%)}"
    ".brandimg{display:block;width:min(100%,430px);height:auto}"
    ".brandhint{padding:12px 16px;border-radius:999px;background:rgba(238,248,255,.16);font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted);backdrop-filter:blur(18px) saturate(110%)}"
    ".hero{display:grid;grid-template-columns:1.4fr .9fr;gap:18px;align-items:stretch}"
    ".card{background:linear-gradient(180deg,rgba(247,252,255,.24),rgba(206,233,249,.13));border:none;border-radius:28px;box-shadow:0 12px 24px var(--shadow);padding:24px 24px 22px;backdrop-filter:blur(22px) saturate(110%)}"
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(236,247,255,.16);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(236,247,255,.16);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(236,247,255,.16);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(236,247,255,.16);border:none}"
    ...
    ".pill{padding:10px 14px;border-radius:999px;background:rgba(236,247,255,.16);border:none;font-size:13px;font-weight:700;color:var(--muted)}"
