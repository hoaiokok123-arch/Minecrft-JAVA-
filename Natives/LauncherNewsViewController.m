...
static NSString *const kLauncherIntroHTML =
    ...
    "<style>"
    ":root{color-scheme:light only;--bg:rgba(255,255,255,.2);--soft:rgba(9,18,36,.72);--muted:rgba(20,33,56,.62);--accent:#58c0ff;--accent2:#7f6dff;--success:#4ad18b;}"
    ...
    ".card{background:linear-gradient(180deg,rgba(255,255,255,.22),rgba(255,255,255,.12));border:none;border-radius:28px;box-shadow:0 14px 30px rgba(3,12,30,.09);padding:24px 24px 22px;backdrop-filter:saturate(125%)}"
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(255,255,255,.24);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(255,255,255,.18);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(255,255,255,.2);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(255,255,255,.16);border:none}"
    ...
    ".pill{padding:10px 14px;border-radius:999px;background:rgba(255,255,255,.18);border:none;font-size:13px;font-weight:700;color:var(--muted)}"
