...
static NSString *const kLauncherIntroHTML =
    ...
    "<style>"
    ":root{color-scheme:light only;--soft:rgba(18,18,20,.88);--muted:rgba(46,41,36,.64);--blue:#165fd1;--green:#63b82b;--shadow:rgba(18,15,12,.07);}"
    ...
    "body::before,body::after{content:'';position:fixed;inset:auto;pointer-events:none;filter:blur(8px);opacity:.42}"
    "body::before{width:320px;height:320px;left:-80px;top:18px;background:radial-gradient(circle at center,rgba(255,239,214,.18),rgba(255,239,214,0));}"
    "body::after{width:360px;height:360px;right:-120px;top:180px;background:radial-gradient(circle at center,rgba(249,244,233,.14),rgba(249,244,233,0));}"
    ...
    ".brandplate{display:inline-flex;align-items:center;gap:12px;padding:10px 14px;border-radius:24px;background:linear-gradient(180deg,rgba(255,252,247,.8),rgba(244,238,229,.4));box-shadow:0 12px 24px rgba(18,15,12,.07);backdrop-filter:blur(20px) saturate(112%)}"
    ".brandimg{display:block;width:min(100%,430px);height:auto}"
    ".brandhint{padding:12px 16px;border-radius:999px;background:rgba(248,243,235,.22);font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted);backdrop-filter:blur(16px) saturate(112%)}"
    ".hero{display:grid;grid-template-columns:1.4fr .9fr;gap:18px;align-items:stretch}"
    ".card{background:linear-gradient(180deg,rgba(252,249,243,.18),rgba(236,230,220,.1));border:none;border-radius:28px;box-shadow:0 12px 24px var(--shadow);padding:24px 24px 22px;backdrop-filter:blur(20px) saturate(114%)}"
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(248,243,235,.22);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(248,243,236,.17);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(248,243,236,.16);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(248,243,236,.14);border:none}"
    ...
    ".pill{padding:10px 14px;border-radius:999px;background:rgba(248,243,236,.15);border:none;font-size:13px;font-weight:700;color:var(--muted)}"
    ...
    "<p class='lead'>A compact Chill Launcher build for iPhone and iPad with faster startup, cleaner profile management, lighter glass surfaces and launcher video backgrounds that stay visible behind the controls.</p>"
    "<div class='stats'>"
    ...
    "<div class='stat'><strong>iOS Glass</strong><span>Grey frosted cards with softer blur</span></div>"
    "</div>"
    "</article>"
