...
static NSString *const kLauncherIntroHTML =
    ...
    "<style>"
    ":root{color-scheme:light only;--soft:rgba(20,18,16,.88);--muted:rgba(62,53,43,.64);--blue:#165fd1;--green:#63b82b;--shadow:rgba(22,18,14,.06);}"
    ...
    "body::before{width:320px;height:320px;left:-80px;top:18px;background:radial-gradient(circle at center,rgba(255,244,225,.16),rgba(255,244,225,0));}"
    "body::after{width:360px;height:360px;right:-120px;top:180px;background:radial-gradient(circle at center,rgba(255,250,241,.12),rgba(255,250,241,0));}"
    ...
    ".brandplate{display:inline-flex;align-items:center;gap:12px;padding:10px 14px;border-radius:24px;background:linear-gradient(180deg,rgba(255,253,248,.88),rgba(247,240,229,.54));box-shadow:0 12px 24px rgba(22,18,14,.06);backdrop-filter:blur(22px) saturate(108%)}"
    ".brandimg{display:block;width:min(100%,430px);height:auto}"
    ".brandhint{padding:12px 16px;border-radius:999px;background:rgba(251,246,238,.22);font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted);backdrop-filter:blur(18px) saturate(108%)}"
    ".hero{display:grid;grid-template-columns:1.4fr .9fr;gap:18px;align-items:stretch}"
    ".card{background:linear-gradient(180deg,rgba(255,252,247,.22),rgba(241,234,224,.12));border:none;border-radius:28px;box-shadow:0 12px 24px var(--shadow);padding:24px 24px 22px;backdrop-filter:blur(22px) saturate(110%)}"
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(251,246,238,.24);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.18);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.17);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.15);border:none}"
    ...
    ".pill{padding:10px 14px;border-radius:999px;background:rgba(251,246,239,.16);border:none;font-size:13px;font-weight:700;color:var(--muted)}"
