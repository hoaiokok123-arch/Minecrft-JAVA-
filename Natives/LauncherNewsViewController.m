...
static NSString *const kLauncherIntroHTML =
    ...
    "<style>"
    ":root{color-scheme:light only;--soft:rgba(13,19,28,.9);--muted:rgba(31,40,54,.68);--blue:#165fd1;--green:#63b82b;--shadow:rgba(5,14,24,.08);}"
    ...
    "body::before,body::after{content:'';position:fixed;inset:auto;pointer-events:none;filter:blur(6px);opacity:.58}"
    "body::before{width:320px;height:320px;left:-80px;top:18px;background:radial-gradient(circle at center,rgba(88,192,255,.24),rgba(88,192,255,0));}"
    ...
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(234,238,243,.26);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(236,240,245,.18);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(236,240,245,.17);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(236,240,245,.15);border:none}"
