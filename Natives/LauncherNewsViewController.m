...
static NSString *const kLauncherIntroHTML =
    ...
    ".brandplate{display:inline-flex;align-items:center;gap:12px;padding:10px 14px;border-radius:24px;background:linear-gradient(180deg,rgba(255,252,247,.22),rgba(241,234,224,.12));box-shadow:0 12px 24px var(--shadow);backdrop-filter:blur(22px) saturate(110%)}"
    ".brandimg{display:block;width:min(100%,430px);height:auto}"
    ".brandhint{padding:12px 16px;border-radius:999px;background:rgba(251,246,239,.16);font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted);backdrop-filter:blur(18px) saturate(110%)}"
    ...
    ".badge{display:inline-flex;align-items:center;gap:10px;padding:10px 14px;border-radius:999px;background:rgba(251,246,239,.16);border:none;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}"
    ...
    ".stat{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.16);border:none}"
    ...
    ".chip{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.16);border:none}"
    ...
    ".feature-item,.step-item{padding:16px 18px;border-radius:22px;background:rgba(251,246,239,.16);border:none}"
