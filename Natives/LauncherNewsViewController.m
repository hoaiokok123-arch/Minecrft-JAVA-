...
static NSString *const kLauncherNewsGlassCSS =
    ...
    "background:rgba(18,20,26,.24)!important;"
    "border:1px solid rgba(255,255,255,.11)!important;"
    "box-shadow:0 12px 28px rgba(0,0,0,.14),inset 0 1px 0 rgba(255,255,255,.07)!important;"
    ...
    "background:rgba(18,20,26,.23)!important;"
    "border:1px solid rgba(255,255,255,.1)!important;"
    "border-radius:18px!important;"
    "box-shadow:0 14px 30px rgba(0,0,0,.12),inset 0 1px 0 rgba(255,255,255,.06)!important;"
    "backdrop-filter:blur(14px) saturate(115%);-webkit-backdrop-filter:blur(14px) saturate(115%);"
