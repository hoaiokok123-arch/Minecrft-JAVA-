...
- (void)applyLauncherAppearance {
    ...
    self.accountButton.layer.borderWidth = getLauncherOutlineControlsEnabled() ? 1.0 / UIScreen.mainScreen.scale : 0.0;
    self.accountButton.layer.borderColor = [UIColor colorWithWhite:1 alpha:0.18].CGColor;
    self.accountButton.backgroundColor = [UIColor colorWithRed:18/255.0 green:20/255.0 blue:26/255.0 alpha:0.2];
