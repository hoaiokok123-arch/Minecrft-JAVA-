...
- (void)refreshUI {
    ...
    self.statusLabel.text = session.isSignedIn
        ...
        : localize(@"openai_auth.status.header.signed_out", nil);
    ...
    NSString *codeVerifier = [getPrefObject(@"ai.oauth_code_verifier") description] ?: @"";
    ...
    self.infoTextView.text = [NSString stringWithFormat:
        ...
        localize(@"openai_auth.info.code_verifier", nil), codeVerifier,
